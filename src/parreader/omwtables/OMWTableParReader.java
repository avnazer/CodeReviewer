...
import parreader.filemanagers.FileManager;
import parreader.filemanagers.XMLDomReader;

public class OMWTableParReader {
    private String parFileDirectory;
    private OMWTable omwTable;
    private static Logger log = Logger.getLogger(OMWTableParReader.class.getCanonicalName());
